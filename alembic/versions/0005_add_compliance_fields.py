...
def upgrade() -> None:
    ...
    op.add_column('missions', sa.Column('compliance_category', sa.String(length=64), server_default='operational', nullable=False))
    ...
    op.add_column('execution_tasks', sa.Column('compliance_category', sa.String(length=64), server_default='operational', nullable=False))
    op.add_column('execution_tasks', sa.Column('jurisdiction', sa.String(length=64), server_default='US-ALL', nullable=False))
    op.add_column('execution_tasks', sa.Column('requires_human_review', sa.Boolean(), server_default='false', nullable=False))
