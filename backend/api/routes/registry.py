...
class AssetCreateRequest(BaseModel):
    ...
    dependencies: Optional[List[str]] = Field(default_factory=list, description="Dependent asset IDs")
...
async def get_dependencies(asset_id: str, recursive: bool = Query(False, description="Get transitive dependencies")):
    """
