...
class LLMMetricsWrapper(BaseChatModel):
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            result = self.llm_instance.generate([messages], stop=stop, callbacks=run_manager.get_child() if run_manager else None, **kwargs)
    ...
    async def _agenerate(
        ...
        **kwargs: Any,
        ...
        try:
            result = await self.llm_instance.agenerate([messages], stop=stop, callbacks=run_manager.get_child() if run_manager else None, **kwargs)
