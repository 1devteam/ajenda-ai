...
class GovernanceRateLimiter(BaseHTTPMiddleware):
    ...
    OPERATION_MULTIPLIERS = {"read": 1.0, "write": 0.7, "delete": 0.5, "approve": 0.3}
    ...
    async def _get_risk_tier_from_request(self, request: Request) -> Optional[RiskTier]:
        """
    ...
    def _calculate_rate_limit(
        self, authority: str, operation: str, risk_tier: Optional[RiskTier]
    ) -> int:
        """
        Calculate effective rate limit
