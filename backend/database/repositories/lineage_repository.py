...
class LineageRepository(BaseRepository[GovernanceLineageEvent]):
    ...
    def get_asset_history(
        ...
        return query.order_by(desc(GovernanceLineageEvent.timestamp)).limit(limit).offset(offset).all()
    ...
    def get_by_actor(
        ...
        Returns:
            List of GovernanceLineageEvent instances
        """
        return self.db.query(GovernanceLineageEvent).filter(
            GovernanceLineageEvent.actor_id == actor_id
        ).order_by(desc(GovernanceLineageEvent.timestamp)).limit(limit).offset(offset).all()
    ...
    def get_by_event_type(
        ...
        """
        return self.db.query(GovernanceLineageEvent).filter(
            GovernanceLineageEvent.event_type == event_type
        ).order_by(desc(GovernanceLineageEvent.timestamp)).limit(limit).offset(offset).all()
    ...
    def get_recent_events(
        ...
        return self.db.query(GovernanceLineageEvent).filter(
            GovernanceLineageEvent.timestamp >= cutoff
        ).order_by(desc(GovernanceLineageEvent.timestamp)).limit(limit).all()
