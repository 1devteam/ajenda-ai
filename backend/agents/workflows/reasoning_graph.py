...
class ReasoningWorkflow:
    ...
    def _build_graph(self) -> StateGraph:
        ...
        workflow.add_conditional_edges(
            ...
            {
                "continue": WorkflowNode.ADAPTER,
                "finalize": WorkflowNode.FINALIZER
            }
        )
    ...
    async def _plan_node(self, state: ReasoningState) -> Dict[str, Any]:
        ...
        system_prompt = """You are an expert planner. Break down complex objectives into clear, actionable steps.
...
Create a detailed plan to achieve this objective. List 3-7 specific steps."""
    ...
    async def _execute_node(self, state: ReasoningState) -> Dict[str, Any]:
        ...
        system_prompt = """You are an expert executor. Given a specific step, provide a detailed execution strategy and expected outcome."""
...
What should we do next?"""
    ...
    async def _finalize_node(self, state: ReasoningState) -> Dict[str, Any]:
        ...
        system_prompt = """You are a synthesis expert. Given the objective and all execution results, provide a comprehensive final answer."""
