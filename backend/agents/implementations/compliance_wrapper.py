...
from backend.agents.compliance import ComplianceEngine, ComplianceEvaluation
...
class ComplianceAwareMixin:
    ...
    def _init_compliance(self):
        ...
        if not hasattr(self, 'agent_id'):
            raise AttributeError("Agent must have 'agent_id' attribute before initializing compliance")
        if not hasattr(self, 'agent_type'):
            raise AttributeError("Agent must have 'agent_type' attribute before initializing compliance")
        if not hasattr(self, 'tenant_id'):
            raise AttributeError("Agent must have 'tenant_id' attribute before initializing compliance")
