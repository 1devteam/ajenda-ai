...
class PerformanceTest:
    ...
    async def test_health_check_latency(self):
        ...
        self.log_test("Health Check Latency", {
    ...
    async def test_api_response_times(self):
        ...
        self.log_test("API Response Times", {
    ...
    async def test_mission_execution_time(self):
        ...
        async with httpx.AsyncClient(timeout=30.0) as client:
            ...
            self.log_test("Mission Execution Time", {
    ...
    async def test_database_query_performance(self):
        ...
        async with httpx.AsyncClient(timeout=30.0) as client:
            ...
            self.log_test("Database Query Performance", {
