...
def test_evaluate_equals_operator(sample_context):
    ...
    policy = Policy(
        ...
        actions=[PolicyAction(ActionType.ADD_TAG, {"tags": ["matched"]})],
        created_at=now,
        created_by="test-user",
        updated_at=now,
        updated_by="test-user",
...
def test_evaluation_caching(sample_context):
    ...
    policy = Policy(
        ...
        actions=[PolicyAction(ActionType.ADD_TAG, {"tags": ["cached"]})],
        created_at=now,
        created_by="test-user",
        updated_at=now,
        updated_by="test-user",
...
def test_test_policy(sample_context):
    ...
    policy = Policy(
        ...
        actions=[PolicyAction(ActionType.REQUIRE_APPROVAL, {"min_authority_level": 3})],
        created_at=now,
        created_by="test-user",
        updated_at=now,
        updated_by="test-user",
