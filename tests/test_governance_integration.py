...
def test_governance_hooks_non_blocking():
    """Test that governance hooks don't block on errors"""
    # This test verifies that even if governance operations fail,
    # they don't raise exceptions that would break agent operations
    
    # Call hook with invalid data (should not raise)
    try:
        asyncio.run(
        ...
        pytest.fail(f"Governance hook should not raise: {e}")
